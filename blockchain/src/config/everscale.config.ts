...
export default () => ({
  [DEVNET_EVER_ENDPOINT]:
    ...
    'https://venom-testnet.evercloud.dev/5496121f17704e049f75f1f70063d052/graphql',
  [DEVNET_WALLET_PUBLIC_KEY]:
    process.env[DEVNET_WALLET_PUBLIC_KEY] ||
    'd76d531ca7ce3fa7236c2b63f0dce1f157fc35e8f049f9819595c1d0dd5d7399',
  [DEVNET_WALLET_PRIVATE_KEY]:
    process.env[DEVNET_WALLET_PRIVATE_KEY] ||
    '813457914aca71e26b0182c5fe23345f55bce6042bac2702700ec851e6da15ac',
